...
export TG_BOT_TOKEN="1648043935:AAE7QD5CN-OzZvykcGdO_GKKivjISgZY40U"
## 下方填写 @getuseridbot 中获取到的纯数字ID
export TG_USER_ID="895873648"
## Telegram 代理IP（选填）
## 下方填写代理IP地址，代理类型为 http，比如您代理是 http://127.0.0.1:1080，则填写 "127.0.0.1"
## 如需使用，请自行解除下一行的注释
export TG_PROXY_HOST="10.10.10.251"
## Telegram 代理端口（选填）
## 下方填写代理端口号，代理类型为 http，比如您代理是 http://127.0.0.1:1080，则填写 "1080"
## 如需使用，请自行解除下一行的注释
export TG_PROXY_PORT="5890"
## Telegram 代理的认证参数（选填）
